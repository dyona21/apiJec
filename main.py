...
# 2. Adiciona o CORS imediatamente no app que acabou de ser criado
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:4200"], # A porta exata do seu Angular
    allow_credentials=True,
    allow_methods=["*"], # Permite GET, POST, PUT, DELETE
    allow_headers=["*"], # Permite todos os cabeçalhos
)

# 3. Adiciona todas as rotas
